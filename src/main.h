...
static const int64_t MIN_TX_FEE = 200000;
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64_t MAX_MONEY = 10000000 * COIN;
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.03 * COIN;	// 3% monthly interest
...
static const uint256 hashGenesisBlock("0xdf22f301f11a569e19bb5c490260db12c674c84b9a126d1df00897b4fe3450b4");
static const uint256 hashGenesisBlockTestNet("0x000005b02044f583c9c06c7b32c4a27184211bac67506bcfbbcf773bd260f76c");
...
public:
    ...
    {
        // Mazon: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Mazon: get transaction coin age
...
public:
    ...
    // Mazon: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Mazon: two types of block: proof-of-work or proof-of-stake
    ...
    // Mazon: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Mazon: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Mazon: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Mazon: block index flags
    enum  
    {
